...
def compute_score(snapshots: list[dict[str, Any]], starting_cash: float) -> dict[str, Any]:
    ...
    trend_treasury = 0.5 + 0.5 * math.tanh(_linear_slope(treasury_delta) / TREASURY_TREND_SCALE)
    trend_pop = _trend_cagr(population, CAGR_SCALE_POP)
    trend_happy = _trend_cagr(happiness, CAGR_SCALE_HAPPY)
    ...
    R = cum_renewable / max(cum_total, 1.0)
